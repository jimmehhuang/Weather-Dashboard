...
function LattoName(city){
    var queryUrl = geoCodeUrl + city + '&appid=' + APIKey;
    fetch(queryUrl).then(
        function(){
            var cityLatitude = lat;
            return cityLatitude;
        })
}
function LontoName(city){
    var queryUrl = geoCodeUrl + city + '&appid=' + APIKey;
    fetch(queryUrl).then(
        function(){
            var cityLongitude = lat;
    ...
    fetch(queryUrl)
        .then(function (coordinateResponse) {
            if (coordinateResponse.ok) {
                coordinateResponse.json().then(getCityName);
